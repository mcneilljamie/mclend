...
export const AssetCard = ({ asset, onSupply, onBorrow, onWithdraw, onRepay }: AssetCardProps) => {
  ...
  return (
    <div className="bg-slate-800 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-slate-700">
      <div className="bg-gradient-to-r from-slate-700 to-slate-700 p-4 border-b border-slate-600">
        <div className="flex items-center gap-2.5 mb-3">
          <div className="w-11 h-11 bg-slate-900 rounded-full flex items-center justify-center shadow-sm p-1.5">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-emerald-500/10 rounded-lg p-3 shadow-sm border border-emerald-500/20">
          ...
          <div className="bg-rose-500/10 rounded-lg p-3 shadow-sm border border-rose-500/20">
            <div className="flex items-center gap-1 mb-1">
      ...
      <div className="p-4">
        <div className="space-y-2.5 mb-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs text-slate-400">Total Supplied</span>
            </div>
          ...
          <div className="flex justify-between items-center">
            <span className="text-xs text-slate-400">Available Liquidity</span>
            <span className="text-sm font-semibold text-white">
        ...
        {userPosition && (hasSupplied || hasBorrowed) && (
          <div className="bg-slate-700/50 rounded-lg p-3 mb-4 border border-slate-600">
            <p className="text-xs font-semibold text-slate-300 uppercase tracking-wide mb-1.5">Your Position</p>
            {hasSupplied && (
              <div className="flex justify-between items-center mb-1">
                <span className="text-xs text-slate-400">Supplied</span>
        ...
        <div className="grid grid-cols-2 gap-2.5">
          <button
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold py-2.5 px-3 rounded-lg transition-colors shadow-sm hover:shadow-md"
          >
            Supply
          </button>
          <div className="relative">
            <button
              ...
              className="w-full bg-rose-600 hover:bg-rose-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white text-sm font-semibold py-2.5 px-3 rounded-lg transition-colors shadow-sm hover:shadow-md disabled:shadow-none flex items-center justify-center gap-2"
            >
              {!hasCollateral && <Lock className="w-3.5 h-3.5" />}
              Borrow
            </button>
            {!hasCollateral && (
          ...
          {hasSupplied && (
            <button
              ...
              className="bg-slate-600 hover:bg-slate-700 text-white text-sm font-semibold py-2.5 px-3 rounded-lg transition-colors shadow-sm hover:shadow-md"
            >
              Withdraw
            </button>
          )}
