...
export const UserDashboard = () => {
  ...
  return (
    <div className="bg-slate-800 rounded-xl shadow-md p-7 mb-6 border border-slate-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-slate-700/50 rounded-lg p-5.5 border border-teal-500/30">
        ...
        <div className="bg-slate-700/50 rounded-lg p-5.5 border border-emerald-500/30">
          <div className="flex items-center gap-1.5 mb-2.5">
        ...
        <div className="bg-slate-700/50 rounded-lg p-5.5 border border-rose-500/30">
          <div className="flex items-center gap-1.5 mb-2.5">
        ...
        <div className="bg-slate-700/50 rounded-lg p-5.5 border border-amber-500/30">
          <div className="flex items-center gap-1.5 mb-2.5">
      ...
      {totalDebt > 0 && (
        <div className="mt-6 bg-slate-700/50 rounded-lg p-5.5 border border-slate-600">
